...
from src.controller.pid_controller.pid_controller import PIDController
from src.controller.computed_torque_controller.computed_torque_controller import ComputedTorqueController
...
class TestComputedTorqueController(TestCase):

    def test_pid_control(self):
        model = mujoco.MjModel.from_xml_path("/home/zhangchen/projects/python_scripts/computed_torque_control/assets/universal_robots_ur5e/scene.xml")
